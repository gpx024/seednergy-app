...
const styles = StyleSheet.create({ container: { gap: tokens.spacing.xl }, heading: { gap: tokens.spacing.sm }, title: { ...tokens.typography.display, color: tokens.colors.terracottaText }, body: { ...tokens.typography.body, color: tokens.colors.ink82 }, actions: { gap: tokens.spacing.xs, marginTop: "auto", paddingBottom: tokens.spacing.xl } });
