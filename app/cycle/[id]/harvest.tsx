...
import { AppButton, AppCard, BackHeader, FeedbackState, PhotoFrame, ScreenContainer } from "@/src/ui/components";
...
export default function HarvestScreen() {
  ...
  return <ScreenContainer scroll contentStyle={styles.container}>
    <BackHeader center={<Text style={styles.eyebrow}>HARVEST READY</Text>} />
    ...
    <AppCard variant="nested" style={styles.instruction}><Text style={styles.instructionLabel}>HOW TO HARVEST</Text><Text style={styles.instructionTitle}>{cycle.seed.harvestInstructions}</Text></AppCard>
