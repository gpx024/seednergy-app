...
const styles = StyleSheet.create({
  ...
  error: { ...tokens.typography.bodyStrong, color: tokens.colors.alert, marginVertical: tokens.spacing.sm, textAlign: "center" }, notice: { alignItems: "center", flexDirection: "row", gap: tokens.spacing.sm }, noticeText: { ...tokens.typography.caption, color: tokens.colors.ink82, flex: 1 }
});
