...
import { AppButton, AppCard, AppField, BrandHeader, BrandMark, CycleGauge, CycleProgress, CycleRow, FeedbackState, OptionRow, PhotoFrame, ProcessIcon, ScreenContainer, SectionHeader, SeedCard, StageBadge, SubmenuTab } from "@/src/ui/components";
...
export default function ComponentGalleryScreen() {
  ...
  return (
    <ScreenContainer scroll contentStyle={styles.container}>
      ...
      <GallerySection title="Screen headers"><BrandHeader locationLabel="Hi, Alex" onProfilePress={() => undefined} /><SectionHeader title="My Cycles" /></GallerySection>
      ...
      <GallerySection title="Sub-navigation"><View accessibilityRole="tablist" style={styles.submenu}><SubmenuTab label="Active (2)" onPress={() => undefined} selected /><SubmenuTab label="Completed" onPress={() => undefined} selected={false} /><SubmenuTab label="Archived" onPress={() => undefined} selected={false} /></View></GallerySection>
      <GallerySection title="Cycle row"><CycleRow day={7} imageSource={cress} meta="Day 7 · Next: Check moisture" name="Cress" progress={0.5} status="Ready to harvest" /></GallerySection>
