...
const styles = StyleSheet.create({
  header: { alignItems: "center", flexDirection: "row", flexShrink: 0, justifyContent: "space-between", minHeight: 54, width: "100%" },
  ...
  avatarButton: { alignItems: "center", backgroundColor: tokens.colors.raised, borderRadius: tokens.radii.pill, height: 50, justifyContent: "center", width: 50, ...tokens.elevation.raisedSm },
